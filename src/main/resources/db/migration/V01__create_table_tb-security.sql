create table if not exists tb_usuario (
	...
	active boolean default true comment 'Representa a situação do cadastro que pode ser ativo ou inativo',
    created_at datetime default current_timestamp comment 'Representa a data de criação do registro',
    updated_at datetime default current_timestamp comment 'Representa a data de alteração do registro',
